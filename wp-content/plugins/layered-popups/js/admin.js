...
function ulp_targets_taxonomy_selected(_object, _taxonomy) {
	if (ulp_targets_loading) return false;
	var term_id = jQuery(_object).attr("id");
	term_id = term_id.replace("ulp-targets-taxonomy-"+_taxonomy+"-", "");
	var load_posts = true;
	if (term_id == "all" || jQuery("#ulp-taxonomy-"+_taxonomy+"-all").val() == "off") {
		if (jQuery("#ulp-taxonomy-"+_taxonomy+"-"+term_id).val() == "on") {
			jQuery("#ulp-taxonomy-"+_taxonomy+"-"+term_id).val("off");
			...
			jQuery("#ulp-taxonomy-"+_taxonomy+"-"+term_id).val("on");
			jQuery(_object).addClass("ulp-targets-input-item-selected");
